...
var channelKeys = [];
channelKeys.push(
{ channelNumber: 25983, name: 'The Box (system)', key: '0VQES3P94AEN5I1K', fieldList: [{ field: 1, axis: 'T' }, { field: 2, axis: 'O' }, { field: 3, axis: 'O' }, { field: 4, axis: 'O' }, { field: 5, axis: 'O' }, { field: 6, axis: 'O' }, { field: 7, axis: 'O' }, { field: 8, axis: 'O' }] },
{ channelNumber: 25683, name: 'The Box (main unit)', key: '91GX43EXD6RUSL4U', fieldList: [{ field: 4, axis: 'O' }] }
);
/*
...
{channelNumber:25983, name:'The Box (system)',key:'GNQST00GBW05EYGC',fieldList:[{field:1,axis:'T'},{field:2,axis:'O'}]);
             */     /*
